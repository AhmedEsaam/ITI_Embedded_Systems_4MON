 ...
 *
*/
void MSYSTICK_ErrSetIntervalSingle(u32 Copy_u32Ticks, void(*NotificationFunction)(void))
{
    /* Disable SysTick */
 ...
 *
*/
void MSYSTICK_ErrSetIntervalPeriodic(u32 Copy_u32Ticks, void(*NotificationFunction)(void))
{
    /* Set Preload Value */
    SYSTICK->LOAD = Copy_u32Ticks;
...
void MSYSTICK_ErrResetSysTick(void)
{
    SYSTICK->VAL = 0;
}
