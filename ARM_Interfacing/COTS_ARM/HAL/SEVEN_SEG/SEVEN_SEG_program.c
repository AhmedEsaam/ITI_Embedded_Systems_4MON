...
void SEVEN_SEG_voidSendDigit(SEVEN_SEG_t* Copy_pSEVEN_SEG_t_Obj, u8 Copy_u8Digit)
{
	...
	{
	case COMMON_ANODE:
		MDIO_voidSetPortSpecificValue(Copy_pSEVEN_SEG_t_Obj->SEVEN_SEG_u8PORT, Local_u8SevenSegmentValuesComAnode[Copy_u8Digit]);
		break;
	case COMMON_CATHODE:
		MDIO_voidSetPortSpecificValue(Copy_pSEVEN_SEG_t_Obj->SEVEN_SEG_u8PORT, Local_u8SevenSegmentValuesComCathode[Copy_u8Digit]);
		break;
	default:
		/* Do Nothing */
		break;
...
void SEVEN_SEG_voidClrDisplay(SEVEN_SEG_t* Copy_pSEVEN_SEG_t_Obj)
{
	...
	{
	case COMMON_ANODE:
		MDIO_voidSetPortSpecificValue(Copy_pSEVEN_SEG_t_Obj->SEVEN_SEG_u8PORT, ALL_OFF_COM_ANODE);
		break;
	case COMMON_CATHODE:
...
{
	MDIO_voidSetPortSpecificValue(Copy_pSEVEN_SEG_t_Obj->SEVEN_SEG_u8PORT, Copy_u8CustomCharacter);
}
